...
const es: Dictionary = {
  ...
  systems: {
    ...
    items: {
      sirius: {
        ...
        description:
          "Sirius es el agente de IA de Lumni para tu PC. Pegas tu clave de API, eliges el proveedor y trabaja en tu máquina: código, archivos, Chrome, skills, voz, correo y más. Compatible con Claude, GPT, Gemini, DeepSeek y otras IAs del mercado.",
        highlights: [
          "Corre en Windows",
          "Tu clave de API",
          "Varias IAs del mercado",
          "Archivos y terminal",
          "Skills y agentes",
          "Chrome",
          "Voz",
  ...
  legal: {
    ...
    home: "Inicio",
    courtesyNote:
      "Este documento se ofrece en inglés por conveniencia. En caso de conflicto, prevalece la versión original en portugués.",
  },
};
