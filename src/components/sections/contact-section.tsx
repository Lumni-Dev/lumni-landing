...
export function ContactSection({ channels }: ContactSectionProps) {
  return (
    ...
    >
      ...
      <Reveal delay={200}>
        <Spotlight className="mt-24 border border-ink-800 bg-ink-950/70 backdrop-blur-sm">
              ...
              <li key={channel.kind} className={index > 0 ? "border-t border-ink-800" : ""}>
                ...
                >
                  <span className="flex items-center gap-6">
                    <span className="flex h-12 w-12 shrink-0 items-center justify-center border border-ink-700 text-ink-300 transition-all duration-500 group-hover:border-ink-400 group-hover:text-white">
